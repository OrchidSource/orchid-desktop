...
(async () => {
    ...
    virtual.retain();
    var user_data = app.getPath("userData");
    require('child_process').spawn('/Applications/Google Chrome.app/Contents/MacOS/Google Chrome', ['--user-data-dir="' + user_data + '"', '--proxy-server="socks5://localhost:6464"']);
}); }); }); });
})().catch();
